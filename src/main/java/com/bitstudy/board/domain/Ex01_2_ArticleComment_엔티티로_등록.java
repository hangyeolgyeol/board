...
public class Ex01_2_ArticleComment_엔티티로_등록 {
    ...
    /*
        ...
        댓글은 여러개: 게시글1개 이기 때문에 단방향 바인딩 이기에
    ...
    */
    ...
    private Ex01_2_ArticleComment_엔티티로_등록(String content, Ex01_1_Article_엔티티로_등록 article) {
        this.content = content;
        this.article = article;
    }

    public Ex01_2_ArticleComment_엔티티로_등록(Ex01_1_Article_엔티티로_등록 article, String content) {
    }
    ...
    /* Ex01_1, Ex01_2, Ex01_3 다 하고 어플리케이션(BoardApplication.java) 실행 해보기
        ...
        이거 하는 이유: Run탭에서 빌드작업을 하거나 테스트를 하게 되면 실행 로그랑 서비스 로그를 분리해서 볼 수 있음.
    */
